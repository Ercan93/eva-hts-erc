...
const tableHeaderOptions = [
  { value: "daily", name: "Date" },
  { value: "profit", name: "Profit" },
  { value: "fba", name: "FBA" },
  { value: "fbm", name: "FBM" },
  { value: "wearables", name: "Wearables" },
